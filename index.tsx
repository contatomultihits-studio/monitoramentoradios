...
const RADIO_STREAM_URLS: Record<string, string> = {
  ...
  'Energia FM': 'https://26683.live.streamtheworld.com/ENERGIA_97_FM.mp3?dist=site',
      ...
      <div className="relative z-10 bg-[#5279FF]/10 border-b border-white/70 shadow-sm backdrop-blur">
        <div className="max-w-6xl mx-auto px-6 py-3">
          <div className="flex gap-2 flex-wrap">
            {['Metropolitana FM', 'Antena 1', 'Forbes Radio', 'MIX Rio FM', 'Dumont FM', 'Energia FM', 'Gazeta FM'].map(r => (
